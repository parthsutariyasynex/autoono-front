        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white w-full max-w-5xl rounded-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="bg-black text-white px-5 py-3 flex items-center justify-between">
                    <h2 className="text-[14px] font-bold uppercase tracking-wide">{t("orders.makePayment")}</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black text-gray-700 uppercase tracking-widest">{t("orders.orderId")}</label>
                            <input
                                type="text"
                                readOnly
                        ...
                        {/* Customer Name */}
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black text-gray-700 uppercase tracking-widest">{t("m.customer-name") || "Customer Name"}</label>
                            <input
                                type="text"
                                readOnly
                                value={customerName}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-sm text-[13px] text-black outline-none focus:border-black transition-colors cursor-pointer"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-sm text-[13px] text-gray-500 outline-none font-bold"
                            />
                        </div>
                        ...
                        {/* Paid Payment */}
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black text-gray-700 uppercase tracking-widest">Paid Payment <span className="text-red-500 inline">*</span></label>
                            <input
                                type="number"
                                required
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-sm text-[13px] text-black outline-none focus:border-black transition-colors resize-none"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-100">
                        <button
                            ...
                            className="bg-[#1D70B8] hover:bg-[#155a96] text-white px-8 py-2.5 rounded-sm font-bold text-[13px] transition-all active:scale-95 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
                        >
