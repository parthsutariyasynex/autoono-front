            ...
            <div className="p-6 space-y-7">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-400 font-bold text-[9px] uppercase tracking-widest">Subtotal</span>
                ...
                <div className="pt-6 border-t border-gray-50 flex flex-col gap-3">
                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Discount Code</label>
                ...
                <div className="pt-4">
                    <div className="flex justify-between items-end mb-6">
                        <span className="text-gray-900 font-bold text-[10px] uppercase tracking-widest mb-1.5">Grand Total</span>
