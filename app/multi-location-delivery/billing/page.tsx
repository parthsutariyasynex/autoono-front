...
//                 <h1 className="text-h3 sm:text-h2 md:text-h1-sm font-bold text-black text-center uppercase mb-8 md:mb-16 tracking-tight">
//                     {t("multi.billingInfo")}
//                 </h1>
...
//                                     <p className="font-bold text-body-lg md:text-[15px] uppercase mb-1">{currentAddress.firstname} {currentAddress.lastname}</p>
...
//                                                     )}
//                                                 </div>
//                                                 <span className="text-body md:text-body-lg font-bold text-black uppercase tracking-tight group-hover:text-primary transition-colors mt-0.5">
...
//                                             <div className="absolute w-2 h-2 bg-primary rounded-full" />
//                                         </div>
//                                         <span className="text-body md:text-body-lg font-bold text-black uppercase tracking-tight mt-0.5">
...
//                         disabled={isSubmitting}
//                         className="w-full sm:w-auto text-center bg-black text-white px-6 md:px-10 py-3.5 md:py-4 text-label font-bold uppercase tracking-[0.15em] hover:opacity-90 transition-opacity disabled:opacity-50"
//                     >
