    ...
    return (
        ...
        >
            <div className="flex flex-col bg-white font-sans" dir={isRtl ? "rtl" : "ltr"}>
                {/* Yellow Header */}
                <div className="bg-[#fdb913] py-5 flex items-center justify-center relative">
                    <h2 className="text-[14px] font-black text-black uppercase tracking-wider">
                ...
                <div className="px-10 py-12 flex flex-col items-center">
                    <p className="text-[16px] font-medium text-black mb-1 text-center leading-relaxed">
                    ...
                    <div className="flex w-full gap-5">
                        <button
                            ...
                            className="flex-1 h-[62px] bg-[#fdb913] text-black font-black text-[13px] uppercase tracking-wider rounded-lg hover:opacity-90 transition-opacity active:scale-[0.98]"
                        >
                            {t("cart.proceed_to_cart") || "PROCEED TO CART"}
                        </button>
                        <button
                            onClick={onClose}
                            className="flex-1 h-[62px] bg-black text-white font-black text-[13px] uppercase tracking-wider rounded-lg hover:opacity-90 transition-opacity active:scale-[0.98]"
                        >
