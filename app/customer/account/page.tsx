                                ...
                                <div className="bg-white border border-[#ebebeb] rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                                    ...
                                    <div className="p-8 text-body text-gray-700 space-y-4 font-medium leading-relaxed">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-8 pt-8">
                                            <Link href={lp("/customer/account/edit")} className="text-primary text-label font-black uppercase tracking-widest hover:text-black transition-colors flex items-center gap-2 group">
                                                Edit Information
                                                <span className="transform group-hover:translate-x-1 transition-transform">→</span>
                                            </Link>
                                            <Link href={lp("/customer/account/edit?change=password")} className="text-primary text-label font-black uppercase tracking-widest hover:text-black transition-colors flex items-center gap-2 group">
                                                Change Password
                                                <span className="transform group-hover:translate-x-1 transition-transform">→</span>
                                            </Link>
                                        </div>
