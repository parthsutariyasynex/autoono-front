                ...
                <main className="flex-1 w-full px-4 md:px-6 lg:px-8 py-10 min-w-0" dir={isRtl ? "rtl" : "ltr"}>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mb-6 md:mb-8">
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto bg-primary hover:bg-primary text-black font-black h-[40px] px-4 md:px-6 rounded-md text-xs uppercase tracking-widest transition-all shadow-sm active:scale-95"
                        >
                            {t("m.search")}
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-end mb-6 md:mb-10 bg-white p-4 md:p-6 border border-[#ebebeb] rounded-md shadow-sm">
                        <div className="w-full sm:w-auto sm:min-w-[200px]">
                            ...
                            <PortalDropdown
                                ...
                                buttonClassName="w-full h-[40px] bg-white text-black font-bold border border-gray-300 rounded-md px-4 text-xs ltr:text-left rtl:text-right flex items-center justify-between cursor-pointer focus:outline-none focus:border-primary"
                            />
                        </div>
